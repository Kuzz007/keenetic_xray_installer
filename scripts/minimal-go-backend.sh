...
#
# Vendored directly in main (previously this fetched a second, older backend
# script from a pinned historical commit; that made every fresh Minimal Go
# install depend forever on that old ref staying reachable under the same
# repo name). See docs/legacy.md for the prior arrangement.
