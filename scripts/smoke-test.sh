...
check_contains install.sh '--direct-init-experimental' "install.sh keeps direct-init experimental compatibility alias"
check_contains install.sh '--direct-init-post-check' "install.sh keeps direct-init post-check compatibility alias"
check_contains install.sh '--direct-full-dry-run' "install.sh keeps direct-full dry-run compatibility alias"
check_contains install.sh '--direct-full-experimental' "install.sh keeps direct-full apply compatibility alias"
check_contains install.sh '--direct-uninstall-dry-run' "install.sh keeps direct-uninstall dry-run compatibility alias"
...
check_contains scripts/xray-go-direct-full.sh 'current_binary_matches_manifest' "direct-full can detect already-current binary"
check_contains scripts/xray-go-direct-full.sh 'Skipping Go resolver download' "direct-full can skip release binary download when sha256 matches"
check_contains scripts/xray-go-direct-full.sh 'maybe_install_binary' "direct-full routes binary install through skip-aware helper"
