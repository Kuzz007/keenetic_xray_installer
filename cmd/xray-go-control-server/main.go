...
func routerKeyboard(routerID string) inlineKeyboard { return inlineKeyboard{InlineKeyboard: [][]inlineButton{{{Text:"📊 Статус",CallbackData:"act:status:"+routerID},{Text:"🩺 Doctor",CallbackData:"act:doctor:"+routerID}},{{Text:"⬆️ Основной",CallbackData:"act:switch_primary:"+routerID},{Text:"⬇️ Резерв",CallbackData:"act:switch_backup:"+routerID}},{{Text:"🔗 Источники",CallbackData:"sources:"+routerID}},{{Text:"🛡 Recovery status",CallbackData:"act:recover_status:"+routerID},{Text:"♻️ Recover now",CallbackData:"act:recover:"+routerID}},{{Text:"🕘 History",CallbackData:"act:history:"+routerID},{Text:"👁 Watchdog log",CallbackData:"act:watchdog:"+routerID},{Text:"🤖 Agent log",CallbackData:"act:agentlog:"+routerID}},{{Text:"📄 Recovery log",CallbackData:"act:recoverylog:"+routerID},{Text:"📬 Results",CallbackData:"act:results:"+routerID}},{{Text:"🔄 Скрипты",CallbackData:"act:update_scripts:"+routerID},{Text:"🔁 Агент",CallbackData:"act:update_agent:"+routerID}},{{Text:"🔄 Перезагрузить роутер",CallbackData:"act:reboot:"+routerID}},{{Text:"📦 Установка агента",CallbackData:"install:"+routerID}},{{Text:"🗑 Удалить роутер",CallbackData:"delete-router:"+routerID}},{{Text:"⬅️ Назад",CallbackData:"routers"},{Text:"🏠 Главное меню",CallbackData:"menu"}}}} }
