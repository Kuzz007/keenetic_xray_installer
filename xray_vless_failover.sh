...
while true; do
    ...
    case "$MENU_CHOICE" in
        ...
        3) SUBSCRIPTION_AUTO_CMD="${SUBSCRIPTION_AUTO_CMD:-/opt/bin/vless-subscription-auto-update}"; [ -x "$SUBSCRIPTION_AUTO_CMD" ] && "$SUBSCRIPTION_AUTO_CMD" || { echo "Команда автообновления подписок не найдена: $SUBSCRIPTION_AUTO_CMD"; pause_menu; } ;;
        4) show_realtime_log ;;
        5) run_diagnostics ;;
